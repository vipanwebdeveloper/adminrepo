...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.user.provider.concrete.admin' => 'getSecurity_User_Provider_Concrete_AdminService',
            ...
            'time_authenticator' => 'getTimeAuthenticatorService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'my_app', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/MazeWorld/MoviesBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AppBundle\\Entity');
        $c->addDriver($b, 'MazeWorld\\MoviesBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'MazeWorldMoviesBundle' => 'MazeWorld\\MoviesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_d0e788f2a926131c3193f9f43305c899aba1c476ca61439eeb30d2ce50a3fe4b');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('MazeWorld\\MoviesBundle\\Entity\\Admin' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.admin' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $c = $this->get('security.user.provider.concrete.admin');
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/forgot-password');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/reset');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administrator/dashboard');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administrator');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/site/tracking');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/tracking/site');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/image');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/rr');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/users/profile');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('^/users');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/dashboard');

        $w = new \Symfony\Component\Security\Http\AccessMap();
        $w->add($i, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $w->add($j, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $w->add($k, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $w->add($l, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $w->add($m, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $w->add($n, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $w->add($o, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $w->add($p, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $w->add($q, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $w->add($r, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $w->add($s, array(0 => 'ROLE_USER'), NULL);
        $w->add($t, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_PTADMIN'), NULL);
        $w->add($u, array(0 => 'ROLE_USER'), NULL);
        $w->add($v, array(0 => 'ROLE_USER'), NULL);

        $x = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $y = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'divine_office_hub_123456', 'admin', array('lifetime' => 31536000, 'always_remember_me' => true, 'name' => 'silva', 'remember_me_parameter' => '_remember_me', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true), $a);

        $z = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $x, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($x, '/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        ...
        $ba = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($x, array());
        $ba->setOptions(array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $ba->setProviderKey('admin');

        $ca = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $x, array(), $a);
        $ca->setOptions(array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $da = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $aa, $x, 'admin', $ba, $ca, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $da->setRememberMeServices($y);

        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($w, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'admin', $a, $d), 2 => $z, 3 => $da, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $y, $g, $a, $d, true, $aa), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5a9984874d85b7.46853569', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('security.user_checker.admin'), 'admin', $h, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d), 7 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $h, $w, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $x, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $x, '/login', false), NULL, NULL, $a, false));
    }
    ...
    /**
     * Gets the public 'time_authenticator' shared service.
     *
     * @return \AppBundle\Security\TimeAuthenticator
     */
    protected function getTimeAuthenticatorService()
    {
        return $this->services['time_authenticator'] = new \AppBundle\Security\TimeAuthenticator($this->get('security.password_encoder'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MazeWorld/MoviesBundle/Resources/views'), 'MazeWorldMovies');
    ...
    {
        $a = $this->get('security.user_checker.admin');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.admin'), $a, 'admin', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'divine_office_hub_123456', 'admin'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a9984874d85b7.46853569')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('admin', '/logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), 'ROLE_PTADMIN' => array(0 => 'ROLE_PTADMIN', 1 => 'ROLE_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_USER', 2 => 'ROLE_ADMIN', 3 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.admin'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'MazeWorldMoviesBundle:Admin', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MazeWorldMoviesBundle' => 'MazeWorld\\MoviesBundle\\MazeWorldMoviesBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'MazeWorldMoviesBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/MazeWorld/MoviesBundle'),
                    'namespace' => 'MazeWorld\\MoviesBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
